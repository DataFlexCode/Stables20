...
//                Set Border_Style to Border_None
                ...
                Function BodyColor Returns String
                    ...
                    Get RgbToHTML of oRgbFunctions iColor to sColor
        ...
        //                        Send AddAttribute "onclick" "alert('CLICK');"
            ...
            Object oButton4 is a Button
                Set Size to 14 129
                Set Location to 62 2
                Set Label to 'Execute JavaScript in browser (WvA)'
            
                Procedure OnClick
                    Handle  hoHtmlDocument
                    Handle  hoHtmlElement
                    Variant vScript
                    Variant vDocument
                    Variant vHtmlElement
                    Get ComDocument of oBrowser to vDocument
                    If (not(IsNullComObject(vDocument))) Begin
                        Get Create (RefClass(cComHTMLDocument)) to hoHtmlDocument
                        If (hoHtmlDocument<>0) Begin
                            Set pvComObject of hoHtmlDocument to vDocument
                            Get ComParentWindow of hoHtmlDocument to vHtmlElement
                            
                            If (not(IsNullComObject(vHtmlElement))) Begin
                                Get Create (RefClass(cComIHTMLWindow2)) to hoHtmlElement
                                Set pvComObject of hoHtmlElement to vHtmlElement
                                
                                  Get ComExecScript of hoHtmlElement "alert('javascript says hello from Wil');" "javascript" to vScript
//                                Get ComExecScript of hoHtmlElement sScriptName "javascript" to vScript
                                Send Destroy of hoHtmlElement
                            End
                            Send Destroy of hoHtmlDocument
                        End
                    End
                End_Procedure
            ...
            Object oButton8 is a Button
                ...
                Procedure OnClick
                    ...
                    If (hDiv) Begin
                        ...
                        Send AddElement of hInnerHTMLBuilder "p" "has the whole world gone mad?"
                        Send UpdateElement of hInnerHTMLBuilder hDiv
                    End
                    Else Begin
                        Send Info_Box "'mydiv' element not found"
                    End
            ...
            Object oTabDialog1 is a TabDialog
                ...
                Object oFolderTab is a TabPage
                    ...
                    Object oBrowser2 is a cComWebBrowserSture
                        ...
                        Procedure OnDirectLinkClicked String sLink 
                            ...
                            Send NavigateToImage of oBrowser3 sLink
                        End_Procedure
                ...
                Object oImageTab is a TabPage
                    ...
                    Object oBrowser3 is a cComWebBrowserSture
                        ...
                        Procedure NavigateToImage String sPath
