            ...
            Object oSampleSelector is a ComboForm
                ...
                Procedure ReadIniFile
                    ...
                    If (sFileName<>"") Begin
                        ...
                        End
                        Else ;
                            Send Info_Box ("Could not parse "+sFileName) "Sort of an error"
                    End
                End_Procedure
                ...
                Procedure OnChange
                    ...
                    If (sValue="1") ;
                            Send DisplayImage JsonExample1.N // Get sample JSON from image
                    If (sValue="2") ;
                            Send DisplayImage JsonExample2.N
                    If (sValue="3") ;
                            Send DisplayImage JsonExample3.N
                    If (sValue="4") ;
                            Send DisplayImage JsonExample4.N
            ...
            Object oTreeView is a TreeView
                ...
                Procedure AddBranch Handle hParent tJsonNode[] aNodes
                    ...
                    For iIndex from 0 to iMax
                        If (aNodes[iIndex].sName<>"") ;
                                Move (aNodes[iIndex].sName+": ") to sLabel
                        Else ;
                                Move "" to sLabel
                        Move aNodes[iIndex].iType to iType
                        If (iType=JNT_OBJECT) ;
                                Move (sLabel*"(Object)") to sLabel
                        If (iType=JNT_ARRAY)  ;
                                Move (sLabel*"(Array)") to sLabel
                        If (iType=JNT_STRING) ;
                                Move (sLabel*aNodes[iIndex].sValue*"(String)") to sLabel
                        If (iType=JNT_NUMBER) ;
                                Move (sLabel*aNodes[iIndex].sValue*"(Number)") to sLabel
                        If (iType=JNT_TRUE)   ;
                                Move (sLabel*"true (Bool)") to sLabel
                        If (iType=JNT_FALSE)  ;
                                Move (sLabel*"false (Bool)") to sLabel
                        If (iType=JNT_NULL)   ; 
                                Move (sLabel*"null") to sLabel
                        
                        Get AddTreeItem sLabel hParent 0 0 0 to hChild
                        
                        If (iType=JNT_OBJECT or iType=JNT_ARRAY) ;
                                Send AddBranch hChild aNodes[iIndex].aChildNodes
                    Loop
                End_Procedure
