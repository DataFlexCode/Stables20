    ...
    Object oGrid is a GridSture
        ...
        Procedure FillGrid tXPToken[] aSymbols
            ...
            For iItem from 0 to iMax
                ...
                If (aSymbols[iItem].stValueHint.iTable>0) Begin
                    Move (sValue+" ("+String(aSymbols[iItem].stValueHint.iTable)+","+String(aSymbols[iItem].stValueHint.iColumn)+")") to sValue
                End
...
//        Set peAnchors to anBottomRight
    ...
    Object oResult is a Form
        ...
        Procedure DisplayValue tXPValue strValue
            String sType
            Get XPValueTypeToString of oExpressionParser strValue.iXPValueType to sType
    ...
    Procedure Execute
        ...
        Get NewGrammar of oExpressionParser to strGrammar
        Get Value of oTextEdit to sExpression
        Get TokenizeString of oExpressionParser strGrammar sExpression (&strError) aSymbolContext to aSymbols
