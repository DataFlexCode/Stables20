            ...
            Object oFolderGrid is a GridSture
                ...
                //Set Select_Mode to No_Select
                 Function VdfFolderName Integer iFolderId Returns String
                    If (iFolderId=VDF_ROOT)     ;
                            Function_Return "VDF root"
                    If (iFolderId=VDF_HTML)     ;
                            Function_Return "HTML root"
                    If (iFolderId=VDF_FILELIST) ;
                            Function_Return "Data folder"
                    If (iFolderId=VDF_PROGRAM)  ;
                            Function_Return "VDF program"
                    Function_Return ""
                End_Function
        ...
        Object oTabPage3 is a TabPage
            ...
            Object oFolderGrid is a GridSture
                ...
                Function WinFolderName Integer iWinFolderId Returns String
                    ...
                    If (iWinFolderId=CSIDL_ADMINTOOLS) ;
                            Function_Return "CSIDL_ADMINTOOLS"
                    If (iWinFolderId=CSIDL_ALTSTARTUP) ;
                            Function_Return "CSIDL_ALTSTARTUP"
                    If (iWinFolderId=CSIDL_APPDATA) ;
                            Function_Return "CSIDL_APPDATA"
                    If (iWinFolderId=CSIDL_BITBUCKET) ;
                            Function_Return "CSIDL_BITBUCKET"
                    If (iWinFolderId=CSIDL_COMMON_ADMINTOOLS) ;
                            Function_Return "CSIDL_COMMON_ADMINTOOLS"
                    If (iWinFolderId=CSIDL_COMMON_ALTSTARTUP) ;
                            Function_Return "CSIDL_COMMON_ALTSTARTUP"
                    If (iWinFolderId=CSIDL_COMMON_APPDATA) ;
                            Function_Return "CSIDL_COMMON_APPDATA"
                    If (iWinFolderId=CSIDL_COMMON_DESKTOPDIRECTORY) ;
                            Function_Return "CSIDL_COMMON_DESKTOPDIRECTORY"
                    If (iWinFolderId=CSIDL_COMMON_DOCUMENTS) ;
                            Function_Return "CSIDL_COMMON_DOCUMENTS"
                    If (iWinFolderId=CSIDL_COMMON_FAVORITES) ;
                            Function_Return "CSIDL_COMMON_FAVORITES"
                    If (iWinFolderId=CSIDL_COMMON_PROGRAMS) ;
                            Function_Return "CSIDL_COMMON_PROGRAMS"
                    If (iWinFolderId=CSIDL_COMMON_STARTMENU) ;
                            Function_Return "CSIDL_COMMON_STARTMENU"
                    If (iWinFolderId=CSIDL_COMMON_STARTUP) ;
                            Function_Return "CSIDL_COMMON_STARTUP"
                    If (iWinFolderId=CSIDL_COMMON_TEMPLATES) ;
                            Function_Return "CSIDL_COMMON_TEMPLATES"
                    If (iWinFolderId=CSIDL_CONTROLS) ;
                            Function_Return "CSIDL_CONTROLS"
                    If (iWinFolderId=CSIDL_COOKIES) ;
                            Function_Return "CSIDL_COOKIES"
                    If (iWinFolderId=CSIDL_DESKTOP) ;
                            Function_Return "CSIDL_DESKTOP"
                    If (iWinFolderId=CSIDL_DESKTOPDIRECTORY) ;
                            Function_Return "CSIDL_DESKTOPDIRECTORY"
                    If (iWinFolderId=CSIDL_DRIVES) ;
                            Function_Return "CSIDL_DRIVES"
                    If (iWinFolderId=CSIDL_FAVORITES) ;
                            Function_Return "CSIDL_FAVORITES"
                    If (iWinFolderId=CSIDL_FONTS) ;
                            Function_Return "CSIDL_FONTS"
                    If (iWinFolderId=CSIDL_HISTORY) ;
                            Function_Return "CSIDL_HISTORY"
                    If (iWinFolderId=CSIDL_INTERNET) ;
                            Function_Return "CSIDL_INTERNET"
                    If (iWinFolderId=CSIDL_INTERNET_CACHE) ;
                            Function_Return "CSIDL_INTERNET_CACHE"
                    If (iWinFolderId=CSIDL_LOCAL_APPDATA) ;
                            Function_Return "CSIDL_LOCAL_APPDATA"
                    If (iWinFolderId=CSIDL_MYPICTURES) ;
                            Function_Return "CSIDL_MYPICTURES"
                    If (iWinFolderId=CSIDL_NETHOOD) ;
                            Function_Return "CSIDL_NETHOOD"
                    If (iWinFolderId=CSIDL_NETWORK) ;
                            Function_Return "CSIDL_NETWORK"
                    If (iWinFolderId=CSIDL_PERSONAL) ;
                            Function_Return "CSIDL_PERSONAL"
                    If (iWinFolderId=CSIDL_PRINTERS) ;
                            Function_Return "CSIDL_PRINTERS"
                    If (iWinFolderId=CSIDL_PRINTHOOD) ;
                            Function_Return "CSIDL_PRINTHOOD"
                    If (iWinFolderId=CSIDL_PROFILE) ;
                            Function_Return "CSIDL_PROFILE"
                    If (iWinFolderId=CSIDL_PROGRAM_FILES) ;
                            Function_Return "CSIDL_PROGRAM_FILES"
                    If (iWinFolderId=CSIDL_PROGRAM_FILES_COMMON) ;
                            Function_Return "CSIDL_PROGRAM_FILES_COMMON"
                    If (iWinFolderId=CSIDL_PROGRAM_FILES_COMMONX86) ;
                            Function_Return "CSIDL_PROGRAM_FILES_COMMONX86"
                    If (iWinFolderId=CSIDL_PROGRAMS) ;
                            Function_Return "CSIDL_PROGRAMS"
                    If (iWinFolderId=CSIDL_RECENT) ;
                            Function_Return "CSIDL_RECENT"
                    If (iWinFolderId=CSIDL_SENDTO) ;
                            Function_Return "CSIDL_SENDTO"
                    If (iWinFolderId=CSIDL_STARTMENU) ;
                            Function_Return "CSIDL_STARTMENU"
                    If (iWinFolderId=CSIDL_STARTUP) ;
                            Function_Return "CSIDL_STARTUP"
                    If (iWinFolderId=CSIDL_SYSTEM) ;
                            Function_Return "CSIDL_SYSTEM"
                    If (iWinFolderId=CSIDL_SYSTEMX86) ;
                            Function_Return "CSIDL_SYSTEMX86"
                    If (iWinFolderId=CSIDL_TEMPLATES) ;
                            Function_Return "CSIDL_TEMPLATES"
                    If (iWinFolderId=CSIDL_WINDOWS) ;
                            Function_Return "CSIDL_WINDOWS"
                    // Some of the folders below this line apparantly only makes sense for Vista+ or IE6+
                    If (iWinFolderId=CSIDL_CDBURN_AREA) ;
                            Function_Return "CSIDL_CDBURN_AREA"
                    If (iWinFolderId=CSIDL_COMMON_MUSIC) ;
                            Function_Return "CSIDL_COMMON_MUSIC"
                    If (iWinFolderId=CSIDL_COMMON_PICTURES) ;
                            Function_Return "CSIDL_COMMON_PICTURES"
                    If (iWinFolderId=CSIDL_COMMON_VIDEO) ;
                            Function_Return "CSIDL_COMMON_VIDEO"
                    If (iWinFolderId=CSIDL_COMPUTERSNEARME) ;
                            Function_Return "CSIDL_COMPUTERSNEARME"
                    If (iWinFolderId=CSIDL_CONNECTIONS) ;
                            Function_Return "CSIDL_CONNECTIONS"
                    If (iWinFolderId=CSIDL_MYDOCUMENTS) ;
                            Function_Return "CSIDL_MYDOCUMENTS"
                    If (iWinFolderId=CSIDL_MYMUSIC) ;
                            Function_Return "CSIDL_MYMUSIC"
                    If (iWinFolderId=CSIDL_MYVIDEO) ;
                            Function_Return "CSIDL_MYVIDEO"
                    If (iWinFolderId=CSIDL_PHOTOALBUMS) ;
                            Function_Return "CSIDL_PHOTOALBUMS"
                    If (iWinFolderId=CSIDL_PLAYLISTS) ;
                            Function_Return "CSIDL_PLAYLISTS"
                    If (iWinFolderId=CSIDL_RESOURCES) ;
                            Function_Return "CSIDL_RESOURCES"
                    If (iWinFolderId=CSIDL_SAMPLE_MUSIC) ;
                            Function_Return "CSIDL_SAMPLE_MUSIC"
                    If (iWinFolderId=CSIDL_SAMPLE_PLAYLISTS) ;
                            Function_Return "CSIDL_SAMPLE_PLAYLISTS"
                    If (iWinFolderId=CSIDL_SAMPLE_PICTURES) ;
                            Function_Return "CSIDL_SAMPLE_PICTURES"
                    If (iWinFolderId=CSIDL_SAMPLE_VIDEOS) ;
                            Function_Return "CSIDL_SAMPLE_VIDEOS"
                    Function_Return ""
                End_Function
