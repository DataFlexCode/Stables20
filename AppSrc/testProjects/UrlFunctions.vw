Use Windows.pkg
Use DFClient.pkg
Use TestProjects\HtmlParserObj.vw
...
Object oUrlObjTest is a View
    ...
    Object oUrl is a ComboForm
        ...
        Set value to "http://sture:horse@www.sture.dk/lk;html"
        Procedure Combo_Fill_List
            ...
            Send Combo_Add_Item "www.frontiot.com"
            Send Combo_Add_Item "www.pol.dk"
            Send Combo_Add_Item "www.eb.dk"
            Send Combo_Add_Item "www.cnn.com"
            Send Combo_Add_Item "www.google.com"
            Send Combo_Add_Item "www.dba.dk"
        End_Procedure
   ...
   End_Object
    ...
    Object oUrlAsPath is a Form
        Set Size to 14 318
        Set Location to 187 25
        Set Label to "URL as path-name:"
        Set Label_Justification_Mode to JMode_Top
        Set Label_Col_Offset to 0
    End_Object
    ...
    Object oScraperBtn is a Button
        ...
        Procedure OnClick
            ...
            End
            Else ;
                    Send Info_Box "Document could not be fetched" "Http request error"
        End_Procedure
